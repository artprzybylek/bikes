...
for feature in data['features']:
    ...
    punkty_okregow.append(geo.pop('coordinates'))
plik.close()
...
wyjscie = [[] for i in range(len(punkty_okregow) + 1)]
...
for i in range(len(punkty_okregow)):
    poly1 = Polygon(punkty_okregow[i][0])
    s_0___2 = 0
    s_3___6 = 0
    s_7___12 = 0
    s_13___15 = 0
...
with open('wyniki.csv', 'w', newline='') as csvfile:
    ...
    for i in range(len(punkty_okregow) + 1):
